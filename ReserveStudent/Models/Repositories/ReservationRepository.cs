...
namespace ReserveStudent.Models.Repositories
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        {
            var reservation = _db.Reservations.Include(x => x.RequestingStudent).Include(x => x.ReservationType).ToList();
        ...
        {
            var reservation = _db.Reservations.Include(x=>x.RequestingStudent).Include(x=>x.ReservationType).FirstOrDefault(x=>x.Id==id);
